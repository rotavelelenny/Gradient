...
<?php 
 ...
 if (isset($_POST["submit"])){
    ...
    // Je recupère les donnees de mes champs dans la html
   ...
   $periode_stage2 = $_POST['periode_stage2'];
...
// je me connect à ma base de donnees
...
$requete = $bdd->prepare("INSERT INTO formulaire(Prenom, Nom, Mail, Telephone, periode_stage, periode_stage2) VALUES(?,?,?,?,?,?)");
$requete->execute([$Prenom,$Nom,$Mail,$Telephone,$periode_stage,$periode_stage2]);
...
<body>
  ...
  <div class="container">
    ...
    <div id="wrap"> 
      <div class="header"><h1 class="h1">CENTRE DE FORMATION DE L'A.F.P.A</h1>
    </div>
